...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  */
    ...
    PB9     ------> I2C1_SDA
    */
    GPIO_InitStruct.Pin = QMC_SCL_Pin|QMC_SDA_Pin;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  if(hi2c->Instance==I2C1)
  {
    ...
    PB9     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(QMC_SCL_GPIO_Port, QMC_SCL_Pin);

    HAL_GPIO_DeInit(QMC_SDA_GPIO_Port, QMC_SDA_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  else if(hspi->Instance==SPI2)
  {
    ...
    PB13     ------> SPI2_SCK
    */
    GPIO_InitStruct.Pin = OSD_MOSI_Pin|OSD_MISO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    ...
    GPIO_InitStruct.Pin = OSD_SCLK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI2;
    HAL_GPIO_Init(OSD_SCLK_GPIO_Port, &GPIO_InitStruct);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  else if(hspi->Instance==SPI2)
  {
    ...
    PB13     ------> SPI2_SCK
    */
    HAL_GPIO_DeInit(GPIOC, OSD_MOSI_Pin|OSD_MISO_Pin);

    HAL_GPIO_DeInit(OSD_SCLK_GPIO_Port, OSD_SCLK_Pin);
  ...
  else if(hspi->Instance==SPI3)
  {
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOC, FLASH_SCK_Pin|FLASH_MISO_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  else if(htim->Instance==TIM3)
  {
    ...
    PB5     ------> TIM3_CH2
    */
    GPIO_InitStruct.Pin = SERVO_3_Pin|MOTOR_2_Pin|MOTOR_3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PA10     ------> USART1_RX
    */
    GPIO_InitStruct.Pin = RC_Receiver_TX_Pin|RC_Receiver_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  else if(huart->Instance==USART1)
  {
    ...
    PA10     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, RC_Receiver_TX_Pin|RC_Receiver_RX_Pin);
  ...
  else if(huart->Instance==USART6)
  {
    ...
    PC7     ------> USART6_RX
    */
    HAL_GPIO_DeInit(GPIOC, Telemetry_TX_Pin|Telemetry_RX_Pin);
