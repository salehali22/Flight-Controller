...
#define TELEMETRY_RX_Pin GPIO_PIN_12
#define TELEMETRY_RX_GPIO_Port GPIOB
#define TELEMETRY_TX_Pin GPIO_PIN_13
#define TELEMETRY_TX_GPIO_Port GPIOB
#define Expansion_TX_Pin GPIO_PIN_14
#define Expansion_TX_GPIO_Port GPIOB
#define Expansion_RX_Pin GPIO_PIN_15
#define Expansion_RX_GPIO_Port GPIOB
#define WIFI_RC_TX_Pin GPIO_PIN_8
#define WIFI_RC_TX_GPIO_Port GPIOD
#define WIFI_RC_RX_Pin GPIO_PIN_9
#define WIFI_RC_RX_GPIO_Port GPIOD
...
#define IMU_SCLK_Pin GPIO_PIN_10
#define IMU_SCLK_GPIO_Port GPIOC
