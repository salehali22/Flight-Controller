...
/* ============== Configuration ============== */
#define ICM42688P_SPI           hspi6
#define ICM42688P_CS_PORT       GPIOD
#define ICM42688P_CS_PIN        GPIO_PIN_7
...
/* ============== PWR_MGMT0 Bits ============== */
#define ICM42688P_PWR_GYRO_MODE_LN      (0x03 << 2)
#define ICM42688P_PWR_ACCEL_MODE_LN     (0x03 << 0)
...
typedef struct {
    ...
    int16_t temp_raw;
    ICM42688P_ScaledData_t accel_g;
    ICM42688P_ScaledData_t gyro_dps;
    float temp_c;
} ICM42688P_Data_t;
